...
function AuthInput({
 ...
 {error && (
 <p className="text-tiny px-1 pt-0.5" style={{ color: 'var(--color-error)' }}>
 {error}
 </p>
 )}
 </div>
...
function NameStep() {
 ...
 <p className="text-small text-center mb-7" style={{ color: 'var(--color-text-tertiary)' }}>
...
function LoginScreen() {
 ...
 <p className="text-center text-small" style={{ color: 'var(--color-text-tertiary)' }}
 >
 New here?{' '}
