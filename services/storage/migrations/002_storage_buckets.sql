CREATE TABLE IF NOT EXISTS storage_buckets (
    ...
    name TEXT NOT NULL,                   -- actual bucket name in S3
    display_name TEXT NOT NULL,           -- friendly label
    region TEXT NOT NULL DEFAULT 'us-east-1',
    usage TEXT NOT NULL DEFAULT 'general', -- "video", "thumbnail", "backup", "general"
    max_size_gb BIGINT NOT NULL DEFAULT 0, -- 0 = unlimited
